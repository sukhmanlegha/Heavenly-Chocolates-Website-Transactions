# Heavenly Chocolates Website Transactions Project

setwd("/Users/STSC/Documents/R-projects/project 1")

# Reading Data set
sales <- read.csv(file="Heavenly-Chocolates-Website-Transactions.csv", header=TRUE)
...
# The joint frequencies of the two categorical variables in the dataset using crosstabulation. 
...
#The frequencies as percentages of row total and percentages of column total using two separate table Percentages of column
...
# A box plot for each of the three browser types to graphically summarize the amount spent by the customers by browser type
